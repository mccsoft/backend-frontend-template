...
export class ProductQuery{
    ...
    static get Client() {
      const client = createClient(ProductClient);
      return client;
    }
    ...
    searchUrl(search?: string | null | undefined, productType?: ProductType | null | undefined, lastStockUpdatedAt?: Date | null | undefined, offset?: number | null | undefined, limit?: number | null | undefined, sortBy?: string | null | undefined, sortOrder?: SortOrder | undefined): string {
      let url_ = this.baseUrl + "/api/products?";
    if (search !== undefined && search !== null)
        url_ += "Search=" + encodeURIComponent("" + search) + "&";
    if (productType !== undefined && productType !== null)
...
export class SignUrlQuery{
    ...
    static get Client() {
      const client = createClient(SignUrlClient);
      return client;
    }
...
export class TestDataQuery{
    ...
    static get Client() {
      const client = createClient(TestDataClient);
      return client;
    }
...
export class VersionQuery{
    ...
    static get Client() {
      const client = createClient(VersionClient);
      return client;
    }
